...
- The previous-landlord reference in the apply screen is a demo mock: the
  attach button grants a permanent LANDLORD VERIFIED badge to whoever
  clicks it. No document is uploaded, read, or checked, and nothing proves
  a landlord was ever involved. It stands in for an issuer signature over
  a landlord attestation; a real build would verify that signature in
  circuit. Labeled in app/src/screens/Apply.jsx.
