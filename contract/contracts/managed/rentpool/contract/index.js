...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      apply: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`apply: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('apply',
                                     ...
                                     'rentpool.compact line 23 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(listingId_0).concat(_descriptor_0.toValue(nullifier_0)),
  ...
  initialState(...args_0) {
    ...
    if (!(issuerIncomeKey_0.buffer instanceof ArrayBuffer && issuerIncomeKey_0.BYTES_PER_ELEMENT === 1 && issuerIncomeKey_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'rentpool.compact line 16 char 1',
                                 'Bytes<32>',
                                 issuerIncomeKey_0)
    }
  ...
  _apply_0(context, partialProofData, listingId_0, nullifier_0) {
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'rentpool.compact line 14 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
  ...
  commitToApplicant: (...args_0) => {
    ...
    if (!(listingId_0.buffer instanceof ArrayBuffer && listingId_0.BYTES_PER_ELEMENT === 1 && listingId_0.length === 32)) {
      __compactRuntime.typeError('commitToApplicant',
                                 'argument 1',
                                 'rentpool.compact line 29 char 1',
                                 'Bytes<32>',
                                 listingId_0)
    }
  ...
  refund: (...args_0) => {
    ...
    if (!(listingId_0.buffer instanceof ArrayBuffer && listingId_0.BYTES_PER_ELEMENT === 1 && listingId_0.length === 32)) {
      __compactRuntime.typeError('refund',
                                 'argument 1',
                                 'rentpool.compact line 42 char 1',
                                 'Bytes<32>',
                                 listingId_0)
    }
